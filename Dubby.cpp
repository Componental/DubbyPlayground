...
{
    dubbyParameters[DLY_SYNC].Init(Params(DLY_SYNC), CONTROL_NONE, 0, 0, 1, LINEAR);
    dubbyParameters[DLY_TIME_FREE].Init(Params(DLY_TIME_FREE), KN1, 0, 0, 1000, EXPONENTIAL);
